  ...
  
{
    public partial class Form1 : Form
    {
        ...
        // Adding the missing GetTableName method to resolve CS0103 error
        private string GetTableName(string xmlFilePath)
        {
            // Extract the table name from the XML file name or content
            // For simplicity, using the file name without extension as the table name
            return Path.GetFileNameWithoutExtension(xmlFilePath);
        }
